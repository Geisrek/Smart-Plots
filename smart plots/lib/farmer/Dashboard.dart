      ...
      child:Column(
        children: [
          Row(crossAxisAlignment: CrossAxisAlignment.center,
            ...
            ,SizedBox(height: 20,),Center(child: Row(mainAxisAlignment: MainAxisAlignment.center,children: [MyText(text:"Air humidity"),SizedBox(width: 20,),MyText(text: "Sol humidity"),IconButton(onPressed: (){}, icon:  SvgPicture.asset("./images/history.svg") )],),)
            ,
            SizedBox(height: 20,)
            ,
            Column(children: [
